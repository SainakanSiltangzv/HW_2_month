...
# вызова метода calculate_perimeter и возвращаемый результат метода задавался бы атрибуту perimeter.
    ...
    def info(self):
        print(
            f'Square side length:{self.__side_length} {self.unit}, perimeter:{self.calculate_perimeter()} {self.unit}, area: {self.calculate_area()} {self.unit}.')
...
class Rectangle(Figure):
    ...
    # возвращал площадь прямоугольника.calculate_perimeter, который
    def calculate_area(self):
        return self.__length * self.__width

    # 18. В классе Rectangle переопределить метод  бы считал и
    ...
    def info(self):
        print(
            f'Rectangle length:{self.__length} {self.unit},width:{self.__width} {self.unit}.  perimeter:{self.calculate_perimeter()} {self.unit}, area: {self.calculate_area()} {self.unit}.')
