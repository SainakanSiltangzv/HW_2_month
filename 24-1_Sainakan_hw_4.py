...
def start():
    boss = Boss('Don Corleone', 1250, 50)
    golem = Golem('Zaika', 530, 5)
    witcher = Witcher('Vanda', 340, 0)
    warrior = Warrior('Ahiles', 280, 10)
    doc = Medic('Dr Hause', 250, 5, 15)
    magic = Magic("Hendelf", 260, 20)
    berserk = Berserk('Kratos', 270, 15)
    assistant = Medic('Dr Chase', 290, 10, 5)
